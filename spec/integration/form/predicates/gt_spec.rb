  ...
  context 'as macro' do
    context 'with required' do
      context 'with value' do
        subject(:schema) do
          Dry::Schema.form do
            required(:foo, :int).value(:int?, gt?: 23)
          end
        end
      ...
      context 'with filled' do
        subject(:schema) do
          Dry::Schema.form do
            required(:foo, :int).filled(:int?, gt?: 23)
          end
        end
      ...
      context 'with maybe' do
        subject(:schema) do
          Dry::Schema.form do
            required(:foo, [:nil, :int]).maybe(:int?, gt?: 23)
          end
        end
    ...
    context 'with optional' do
      context 'with value' do
        subject(:schema) do
          Dry::Schema.form do
            optional(:foo, :int).value(:int?, gt?: 23)
          end
        end
      ...
      context 'with filled' do
        subject(:schema) do
          Dry::Schema.form do
            optional(:foo, :int).filled(:int?, gt?: 23)
          end
        end
      ...
      context 'with maybe' do
        subject(:schema) do
          Dry::Schema.form do
            optional(:foo, [:nil, :int]).maybe(:int?, gt?: 23)
          end
        end
